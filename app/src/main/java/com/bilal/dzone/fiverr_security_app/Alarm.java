...
//                    Toast.makeText(Alarm.this, names.get(i).getNum()+"", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(Alarm.this, cityName, Toast.LENGTH_SHORT).show();
                    }
                }
                catch (Exception e){
                    Toast.makeText(Alarm.this, "GPS Error", Toast.LENGTH_SHORT).show();
                }
            }
        }, 3000);
        ...
        if (!sharedPreferences.getString("name", "").equals("") &&
               sharedPreferences.getString("toggle", "").equals("on") ) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(et_pass.equals(pass_)){
                    ...
                    Toast.makeText(Alarm.this, "Wrong Password", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onResult(@NonNull LocationSettingsResult locationSettingsResult) {
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.SUCCESS:
                        ...
                        if (ContextCompat.checkSelfPermission(Alarm.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, Alarm.this);
                        }
                        break;
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:

                        try {
                            status.startResolutionForResult(Alarm.this, REQUEST_CHECK_SETTINGS);
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (!ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                        mRequestingLocationUpdates = false;
                        Toast.makeText(Alarm.this, "Allow all permissions!", Toast.LENGTH_SHORT).show();
                    } else {
                        showRationaleDialog();
                    }
                }
...
//                        Toast.makeText(Alarm.this, all_tokens, Toast.LENGTH_SHORT).show();


                        }
                        else
                        Toast.makeText(Alarm.this, "No Nearby Users Found", Toast.LENGTH_SHORT).show();



                } else {
                    Toast.makeText(Alarm.this, server_response_text, Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Alarm.this, "Error while loading data", Toast.LENGTH_SHORT).show();
            }
